          ...
          <div class="card-body">
            <div class="container px-3 my-3">
              ...
              @endif
                ...
                <div class="form-floating mb-3">
                  <input value="{{$measurement->left_calf ?? null}}" name="left_calf" class="form-control" id="panturrilhaEsquerdaCm" type="text" placeholder="Panturrilha esquerda(cm)" data-sb-validations="required" />
